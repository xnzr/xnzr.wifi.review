...
/**
 * Created by alexe on 06.08.2017.
 */

public final class CameraView
        implements FragmentCompat.OnRequestPermissionsResultCallback, FragmentCallback {

    private Fragment mFragment;
    private android.widget.FrameLayout mLayout;
    private AutoFitTextureView mTextureView;

    public CameraView(Fragment fragment, android.widget.FrameLayout layout) {
        mFragment = fragment;
        mLayout = layout;
    }
    ...
    public void onResume(FrameLayout layout) {
        mFile = new File(mFragment.getActivity().getExternalFilesDir(null), "pic.jpg");

        if (mTextureView == null) {
            mTextureView = new AutoFitTextureView(mFragment.getActivity());
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance(mFragment.getString(R.string.request_permission))
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // coordinate.
                int displayRotation = mFragment.getActivity().getWindowManager().getDefaultDisplay().getRotation();
